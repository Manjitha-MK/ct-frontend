...
const Homepage = () => {
  return (
    <div className="bg-[#050b18] text-white min-h-screen font-sans overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section className="relative h-svh min-h-[600px] md:min-h-[750px] lg:h-[90vh] flex items-end md:items-center justify-center text-white px-4 sm:px-8 md:px-16 lg:px-24 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl pb-12 sm:pb-16 md:pb-0">
          <div className="text-center md:text-left max-w-sm sm:max-w-xl lg:max-w-2xl mx-auto md:mx-0">
            ...
            <p className="mt-3 sm:mt-4 text-gray-400 text-xs sm:text-sm lg:text-base leading-relaxed max-w-xs sm:max-w-md mx-auto md:mx-0">
              Built on passion. Driven by unity. We don’t just play cricket, we
              live it.
            </p>
            ...
            <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              <Link
                to="/players"
                className="w-full sm:w-auto bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-slate-950 px-8 py-3.5 font-black text-xs tracking-wider uppercase rounded-xl transition-all duration-300 shadow-lg shadow-amber-500/10 active:scale-[0.98]"
              >
                Explore Team
              </Link>
              ...
              <Link
                to="/matches"
                className="w-full sm:w-auto border-2 border-gray-700 hover:border-amber-500 text-gray-300 hover:text-amber-400 bg-black/20 backdrop-blur-sm px-8 py-3.5 font-black text-xs tracking-wider uppercase rounded-xl transition-all duration-300 active:scale-[0.98]"
              >
                View Matches
              </Link>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 mt-16 sm:mt-24 lg:mt-32 pb-24 flex flex-col md:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mt-2 leading-tight uppercase">
            MORE THAN A TEAM,
            <br className="hidden lg:block" /> WE ARE A{" "}
          ...
          <p className="text-gray-400 mt-4 text-xs sm:text-sm lg:text-base leading-relaxed max-w-xl mx-auto md:mx-0">
            ...
            Every match is a milestone, and every tournament is a step toward
            global greatness.
          </p>
